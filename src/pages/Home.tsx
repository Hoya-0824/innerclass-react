...
// ✅ NewsDetailModal로 통일 (TrendKeyword도 동일 모달 사용)
// import NewsDetailModal from "../components/News/NewsDetailModal";
import type { NewsItem as ModalNewsItem } from "../data/newsMockData";
import NewsDetailModalMain from "../components/News/NewsDetailModalMain";
...
const Home = () => {
  ...
  // ✅ TrendKeyword도 NewsDetailModal로 열기
  ...
  return (
    <div className="min-h-screen">
      <div className="mx-auto max-w-6xl px-4 py-10">
        {/* ✅ TrendKeyword UX */}
        {selectedTrendNews && <NewsDetailModalMain item={selectedTrendNews} onClose={() => setSelectedTrendNews(null)} />}
